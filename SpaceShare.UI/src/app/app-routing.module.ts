...
const routes: Routes = [
  ...
  { path: 'property/:id/carousel', component: CarouselComponent },
  { path: 'property/:id/features', component: FeaturesComponent },
  { path: 'property/:id/info', component: InfoComponent },
  { path: 'property/:id/info/deal', component: DealComponent },
  { path: 'property/:id/features/host', component: HostComponent },
